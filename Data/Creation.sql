...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hoteles`.`Hotel_theme` ;
...
CREATE TABLE IF NOT EXISTS `Hoteles`.`Travel_Leisure_ranking` (
  ...
  `Hoteles_google_rev_idHoteles_google` VARCHAR(100) NOT NULL,
  `Hotel_theme_idHotel_type` VARCHAR(100) NOT NULL,
  `Location_city_idLocation` VARCHAR(100) NOT NULL,
  ...
  INDEX `fk_Travel_Leisure_ranking_Hoteles_google_rev1_idx` (`Hoteles_google_rev_idHoteles_google` ASC) VISIBLE,
  INDEX `fk_Travel_Leisure_ranking_Hotel_theme1_idx` (`Hotel_theme_idHotel_type` ASC) VISIBLE,
  INDEX `fk_Travel_Leisure_ranking_Location_city1_idx` (`Location_city_idLocation` ASC) VISIBLE,
  CONSTRAINT `fk_Travel_Leisure_ranking_Hotel_theme1`
    FOREIGN KEY (`Hotel_theme_idHotel_type`)
    REFERENCES `Hoteles`.`Hotel_theme` (`idHotel_type`),
  CONSTRAINT `fk_Travel_Leisure_ranking_Hoteles_google_rev1`
    FOREIGN KEY (`Hoteles_google_rev_idHoteles_google`)
  ...
  CONSTRAINT `fk_Travel_Leisure_ranking_Location_city1`
    FOREIGN KEY (`Location_city_idLocation`)
