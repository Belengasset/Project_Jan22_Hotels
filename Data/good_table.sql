...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hoteles`.`Location` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hoteles`.`Hoteles_trip` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hoteles`.`Hotel_type` ;
...
CREATE TABLE IF NOT EXISTS `Hoteles`.`Travel_Leisure_ranking` (
  `idHoteles_ranking` VARCHAR(100) NOT NULL,
  `City` VARCHAR(45) NOT NULL,
  `Score` DECIMAL(2) NOT NULL,
  `Rank` INT NOT NULL,
  `2021_Rank` FLOAT NULL,
  `Past_rank` FLOAT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hoteles`.`Hoteles_google` ;
...
CREATE TABLE IF NOT EXISTS `Hoteles`.`Hoteles_google` (
  ...
  `Travel_Leisure_ranking_idHoteles_ranking` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`idHoteles_google`),
  INDEX `fk_Hoteles_google_Travel_Leisure_ranking1_idx` (`Travel_Leisure_ranking_idHoteles_ranking` ASC) VISIBLE,
  CONSTRAINT `fk_Hoteles_google_Travel_Leisure_ranking1`
    FOREIGN KEY (`Travel_Leisure_ranking_idHoteles_ranking`)
    REFERENCES `Hoteles`.`Travel_Leisure_ranking` (`idHoteles_ranking`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
